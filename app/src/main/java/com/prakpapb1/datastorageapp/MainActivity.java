package com.prakpapb1.datastorageapp;
...
public class MainActivity extends AppCompatActivity {
    public static final String FILENAMME="namafile.txt";
    public static final String PREFNAME="com.prakpapb1.datastorageapp.PREF";
